...
mod tests {
    ...
    #[test]
    fn test_aot_pure_bltz_not_jump() {
        let instructions = vec![
    ...
    #[test]
    fn test_aot_pure_blez_not_jump() {
        let instructions = vec![
            Instruction::new(Opcode::ADD, 29, 0, 1, false, true),
    ...
    #[test]
    fn test_aot_pure_bgtz_not_jump() {
        let instructions = vec![
    ...
    #[test]
    fn test_aot_pure_bgez_not_jump() {
        let instructions = vec![
            Instruction::new(Opcode::ADD, 29, 0, 0xFFFF_FFFF, false, true),
