...
impl<F: PrimeField32> MachineAir<F> for ShaCompressChip {
    ...
    fn generate_trace(
        ...
        for row in rows[num_real_rows..].iter_mut() {
            ...
            cols.index = F::from_canonical_usize(octet_num * 8 + octet);
...
impl ShaCompressChip {
    fn event_to_rows<F: PrimeField32>(
        ...
        for j in 0..8usize {
            ...
            cols.index = F::from_canonical_usize(j);
        ...
        for j in 0..64 {
            ...
            cols.octet_num[octet_num_idx] = F::ONE;
            cols.index = F::from_canonical_usize(8 + j);
        ...
        for j in 0..8usize {
            ...
            cols.octet[j] = F::ONE;
            cols.octet_num[octet_num_idx] = F::ONE;
            cols.index = F::from_canonical_usize(72 + j);
