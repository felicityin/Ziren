...
use slop_algebra::{FieldExtensionAlgebra, FieldAlgebra};
...
impl<GC: IopCtx, K: FieldAlgebra + Copy> Add<K> for MaskCounterContext<GC> {
    type Output = Self;
...
impl<GC: IopCtx, K: FieldAlgebra + Copy> Sub<K> for MaskCounterContext<GC> {
    type Output = Self;
...
impl<GC: IopCtx, K: FieldAlgebra + Copy> Mul<K> for MaskCounterContext<GC> {
    type Output = Self;
