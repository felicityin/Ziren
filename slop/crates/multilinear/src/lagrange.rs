...
pub fn partial_lagrange<F: FieldAlgebra>(point: &Point<F, CpuBackend>) -> Tensor<F, CpuBackend> {
    partial_eq_with_basis(point, Basis::Evaluation)
}

/// Computes the monomial basis partial eq.
pub fn monomial_basis_partial_eq<F: FieldAlgebra>(
    point: &Point<F, CpuBackend>,
) -> Tensor<F, CpuBackend> {
    partial_eq_with_basis(point, Basis::Monomial)
}

pub fn partial_eq_with_basis<F: FieldAlgebra>(
    point: &Point<F, CpuBackend>,
    basis: Basis,
) -> Tensor<F, CpuBackend> {
    let one = F::one();
...
pub fn partial_lagrange_blocking<F: FieldAlgebra>(
    point: &Point<F, CpuBackend>,
) -> Tensor<F, CpuBackend> {
...
pub fn monomial_basis_evals_blocking<F: FieldAlgebra>(
    point: &Point<F, CpuBackend>,
) -> Tensor<F, CpuBackend> {
...
pub fn partial_eq_blocking_with_basis<F: FieldAlgebra>(
    point: &Point<F, CpuBackend>,
    basis: Basis,
) -> Tensor<F, CpuBackend> {
